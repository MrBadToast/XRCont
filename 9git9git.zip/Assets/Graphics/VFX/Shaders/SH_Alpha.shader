...
Shader "SH_Alpha"
{
	Properties
	{
		...
		[ASEEnd]_MainTex_Color("MainTex_Color", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 texCoord2 = IN.ase_texcoord3.xy * _MianTex_Tiling + float2( 0,0 );
				float4 tex2DNode3 = tex2D( _MainTex, texCoord2 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = IN.ase_color.rgb;
				float Alpha = ( IN.ase_color.a * saturate( ( _MainTex_Inten * _MainTex_Color * (( _R )?( tex2DNode3.r ):( tex2DNode3.a )) ) ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord2 = IN.ase_texcoord2.xy * _MianTex_Tiling + float2( 0,0 );
				float4 tex2DNode3 = tex2D( _MainTex, texCoord2 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord2 = IN.ase_texcoord.xy * _MianTex_Tiling + float2( 0,0 );
				float4 tex2DNode3 = tex2D( _MainTex, texCoord2 );
				
				surfaceDescription.Alpha = ( IN.ase_color.a * saturate( ( _MainTex_Inten * _MainTex_Color * (( _R )?( tex2DNode3.r ):( tex2DNode3.a )) ) ) ).r;
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord2 = IN.ase_texcoord1.xy * _MianTex_Tiling + float2( 0,0 );
				float4 tex2DNode3 = tex2D( _MainTex, texCoord2 );
...
/*ASEBEGIN
Version=18935
0;73;1148;660;1653.785;865.3719;2.088799;True;False
Node;AmplifyShaderEditor.Vector2Node;1;-1440.759,123.9849;Inherit;False;Property;_MianTex_Tiling;MianTex_Tiling;2;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;2;-1255.477,99.06265;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-1001.322,84.01446;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;f1474f0b034467f4cbbd96cb8aa8927a;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;4;-589.7841,194.7353;Inherit;False;Property;_R;R;1;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;20;-591.9524,23.3667;Inherit;False;Property;_MainTex_Color;MainTex_Color;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;5;-591.8841,-70.36475;Inherit;False;Property;_MainTex_Inten;MainTex_Inten;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-364.1763,154.3902;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;6;-259.696,-46.44971;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;21;-199.7808,156.2273;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-42.69611,129.113;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;11;128.4802,48.72279;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;SH_Alpha;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638023561436704703;  Blend;0;638023561879827615;Two Sided;1;0;Cast Shadows;0;638023561458909922;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=C999D3AFCFAC0B95C8415C5C4539FF0CDB3424BA