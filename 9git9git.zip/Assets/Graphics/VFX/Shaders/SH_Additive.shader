...
Shader "SH_Additive"
{
	Properties
	{
		...
		[Toggle]_R("R", Float) = 0
		[ASEEnd]_MainTex_Inten("MainTex_Inten", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 texCoord16 = IN.ase_texcoord3.xy * _MianTex_Tiling + float2( 0,0 );
				float4 tex2DNode15 = tex2D( _MainTex, texCoord16 );
				float temp_output_21_0 = ( _MainTex_Inten * (( _R )?( tex2DNode15.r ):( tex2DNode15.a )) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * temp_output_21_0 ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord16 = IN.ase_texcoord2.xy * _MianTex_Tiling + float2( 0,0 );
				float4 tex2DNode15 = tex2D( _MainTex, texCoord16 );
				float temp_output_21_0 = ( _MainTex_Inten * (( _R )?( tex2DNode15.r ):( tex2DNode15.a )) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord16 = IN.ase_texcoord.xy * _MianTex_Tiling + float2( 0,0 );
				float4 tex2DNode15 = tex2D( _MainTex, texCoord16 );
				float temp_output_21_0 = ( _MainTex_Inten * (( _R )?( tex2DNode15.r ):( tex2DNode15.a )) );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord16 = IN.ase_texcoord1.xy * _MianTex_Tiling + float2( 0,0 );
				float4 tex2DNode15 = tex2D( _MainTex, texCoord16 );
				float temp_output_21_0 = ( _MainTex_Inten * (( _R )?( tex2DNode15.r ):( tex2DNode15.a )) );
...
/*ASEBEGIN
Version=18935
0;73;1131;441;501.1608;296.3577;1.3;True;False
Node;AmplifyShaderEditor.Vector2Node;17;-845.4091,-3.559299;Inherit;False;Property;_MianTex_Tiling;MianTex_Tiling;1;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-660.1277,-28.48154;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-405.9722,-43.52974;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;f1474f0b034467f4cbbd96cb8aa8927a;f383ac00b36c17e45a2e1979ae729842;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;18;5.565369,67.1911;Inherit;False;Property;_R;R;2;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;20.46538,-24.90895;Inherit;False;Property;_MainTex_Inten;MainTex_Inten;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;20;208.1732,-154.154;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;231.1732,26.84604;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;451.1732,58.84604;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;424.1732,-111.154;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;6;652.2633,-86.73125;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;SH_Additive;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;True;True;8;1;False;-1;1;False;-1;8;5;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638023559926453757;  Blend;2;638028868389016158;Two Sided;1;0;Cast Shadows;0;638023559989471338;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=22F399A4169626AD8F3EA1183F9AE34975B641EA