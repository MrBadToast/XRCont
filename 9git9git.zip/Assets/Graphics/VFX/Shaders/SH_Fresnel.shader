...
Shader "SH_Fresnel"
{
	Properties
	{
		...
		[ASEBegin]_Fre_Scale("Fre_Scale", Float) = 1
		_Fre_Power_Test("Fre_Power_Test", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 texCoord13 = IN.ase_texcoord4.xyz;
				texCoord13.xy = IN.ase_texcoord4.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float fresnelNdotV10 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode10 = ( 0.0 + _Fre_Scale * pow( 1.0 - fresnelNdotV10, (( _ToggleSwitch0 )?( texCoord13.z ):( _Fre_Power_Test )) ) );
				float temp_output_16_0 = ( _Inten * saturate( fresnelNode10 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * temp_output_16_0 ).rgb;
				float Alpha = ( IN.ase_color.a * temp_output_16_0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				texCoord13.xy = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float fresnelNdotV10 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode10 = ( 0.0 + _Fre_Scale * pow( 1.0 - fresnelNdotV10, (( _ToggleSwitch0 )?( texCoord13.z ):( _Fre_Power_Test )) ) );
				float temp_output_16_0 = ( _Inten * saturate( fresnelNode10 ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				texCoord13.xy = IN.ase_texcoord2.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float fresnelNdotV10 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode10 = ( 0.0 + _Fre_Scale * pow( 1.0 - fresnelNdotV10, (( _ToggleSwitch0 )?( texCoord13.z ):( _Fre_Power_Test )) ) );
				float temp_output_16_0 = ( _Inten * saturate( fresnelNode10 ) );
				
				surfaceDescription.Alpha = ( IN.ase_color.a * temp_output_16_0 );
...
/*ASEBEGIN
Version=18935
0;73;1131;579;1839.728;146.691;1.43178;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-1685.196,321.7572;Inherit;False;Property;_Fre_Power_Test;Fre_Power_Test;1;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1737.034,6.282617;Inherit;False;0;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;14;-1479.719,183.0755;Inherit;False;Property;_ToggleSwitch0;Toggle Switch0;2;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-1456.258,63.55236;Inherit;False;Property;_Fre_Scale;Fre_Scale;0;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;10;-1212.936,3.753416;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-685.4514,-47.65958;Inherit;False;Property;_Inten;Inten;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;20;-730.4579,59.75528;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;17;-501.0764,-183.7213;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-474.4514,5.340424;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-278.0764,-176.7213;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-279.0764,-24.72128;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;-103.8038,-115.9502;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;SH_Fresnel;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;True;True;8;5;False;-1;1;False;-1;8;5;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638037423507844779;  Blend;2;638037423554672149;Two Sided;1;0;Cast Shadows;0;638037423525721689;  Use Shadow Threshold;0;0;Receive Shadows;0;638037423532423723;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=AB7F3EDF7D0A047085FFC39840340C67524C664A